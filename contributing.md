...
이 프로젝트는 Adobe [행동 강령](code-of-conduct.md)을 준수합니다. 참여함으로써,
...
을 프로젝트의 일부로 사용합니다. [CLA에 서명하십시오](http://opensource.adobe.com/cla.html). 본인
...
Adobe는 커뮤니티의 기여를 환영합니다. 참여자를 넘어 한 걸음 더 나아가고 싶다면
