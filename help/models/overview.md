...
1. 왼쪽 레일에서 ![FileData](/help/assets/icons2/FileData.svg) **[!UICONTROL Models]**&#x200B;을(를) 선택합니다.
...
1. **[!UICONTROL Delete]** 확인 대화 상자에서 **[!UICONTROL Delete model]**&#x200B;을(를) 선택하여 모델을 삭제합니다. 취소할 **[!UICONTROL Cancel]**&#x200B;을(를) 선택하십시오.
