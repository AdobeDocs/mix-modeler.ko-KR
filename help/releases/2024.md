---
title: 2024 Mix Modeler 릴리스 정보 보기
description: 2024 Mix Modeler 릴리스 정보 보기
...
# 2024 Mix Modeler 릴리스 정보

## 2024년 10월

| 기능 | 설명 | 일반 가용성 |
|---|---|---|
| **교육 및 채점 예약** | [모델을 만들기](/help/models/create.md#schedule)할 때와 [모델 인사이트](/help/models/insights.md#edit) 또는 모델 테이블의 [컨텍스트 메뉴](/help/models/overview.md#edit)에서 모델을 편집할 때 모델의 교육 및 채점을 예약할 수 있습니다. | 2024년 10월 21일 |
