...
| 기능 | 설명 | 일반 가용성 |
|---|---|---|
| **교육 및 채점 예약** | [모델을 빌드](/help/models/build.md#schedule)할 때와 [모델 인사이트](/help/models/insights.md#edit) 또는 모델 테이블의 [컨텍스트 메뉴](/help/models/overview.md#edit)에서 모델을 편집할 때 모델의 교육 및 점수를 예약할 수 있습니다. | 2024년 10월 21일 |
