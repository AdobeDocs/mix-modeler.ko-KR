...
| 일자 | 날짜 유형 | 채널 | 캠페인 | 지역 | 클릭수 | 지출 |
|--- |:---:|--- |---|---|---:|---:|
| 01-01-2022 | 주 | Facebook | FB_Fall_01 | 미국 | 8000 | 100 |
| 01-08-2022 | 주 | Facebook | FB_Fall_02 | 미국 | 1000 | 10 |
| 01-08-2022 | 주 | Facebook | FB_Fall_01 | 미국 | 7000 | 100 |
...
| 일자 | 날짜 유형 | 채널 | 캠페인 | 브랜드 | 지역 | 목표 | 클릭수 | 지출 | 수입 |
|--- |:---:|--- |--- |--- |---|---|---:|---:|---:|
...
| 01-01-2022 | 주 | Facebook | FB_Fall_01 | Null | 미국 | Null | 8000 | 100 | Null |
| 01-08-2022 | 주 | Facebook | FB_Fall_02 | Null | 미국 | Null | 1000 | 10 | Null |
| 01-08-2022 | 주 | Facebook | FB_Fall_01 | Null | 미국 | Null | 7000 | 100 | Null |
...
1. 집계(요인 또는 요약) 또는 경험 이벤트 데이터 세트의 필드를 조화로운 필드에 매핑하도록 [데이터 세트 규칙](dataset-rules.md)을 설정합니다.
...
1. 상단 표시줄에서 **[!UICONTROL Harmonized data]**&#x200B;을(를) 선택합니다. 정의한 필드, 데이터 세트 규칙, 마케팅 접점 및 전환을 기반으로 조정된 데이터의 요약이 표시됩니다.
   ...
   1. Harmonized 데이터 테이블에 표시되는 Harmonized 필드 열을 수정하려면 ![설정](/help/assets/icons/Setting.svg)을 사용하여 **[!UICONTROL Column settings]** 대화 상자를 엽니다.
      ...
      1. **[!UICONTROL AVAILABLE COLUMNS]**&#x200B;에서 하나 이상의 열을 ![SelectBox](/help/assets/icons/SelectBox.svg)을(를) 선택하고 ![V자형 화살표 오른쪽](/help/assets/icons/ChevronRight.svg)을(를) 사용하여 이러한 열을 **[!UICONTROL SELECTED COLUMNS]**&#x200B;에 추가하십시오. 정의한 모든 표준 조화 필드(**[!UICONTROL Factor Name]**, **[!UICONTROL Factor Value]**, **[!UICONTROL Factor Type]** 및 **[!UICONTROL Factor Value Type]** 등 요소 데이터 세트와 관련된 필드 포함)를 사용할 수 있습니다.
