...
| 스키마 | 데이터 세트가 준수하는 스키마. 스키마 이름을 빠르게 선택하여 의 스키마 편집기의 새 탭에서 스키마를 열 수 있습니다 ![스키마](/help/assets//icons/Schemas.svg) [스키마](../ingest-data/schemas.md). |
...
데이터 세트 규칙을 만들려면 ![데이터 검색](/help/assets//icons/DataCheck.svg) **[!UICONTROL Harmonized data]** > **[!UICONTROL Dataset rules]** Mix Modeler에서 인터페이스, 선택 **[!UICONTROL Create a dataset rule]** 다음에서 **[!UICONTROL Dataset rules configuration]** 마법사.
...
1. 의 데이터 세트를 선택한 경우 **[!UICONTROL Summary]** 범주:
   ...
   1. 규칙의 모든 필드에 대한 매핑이 완료되면 다음을 선택합니다. **[!UICONTROL Save as draft]** 규칙의 초안 버전 저장하기 또는 **[!UICONTROL Save]** 을 클릭하여 규칙을 저장하고 활성화합니다. 선택 **[!UICONTROL Cancel]** 규칙 구성을 취소합니다.
      ...
      ![데이터 세트 규칙 만들기](/help/assets//dataset-create-summary.png)
...
1. 이벤트 범주 데이터 세트를 선택한 경우(**[!UICONTROL Experience Events]**, **[!UICONTROL Adobe Analytics]**, **[!UICONTROL Consumer Experience Events]**), 아래 상자에서 **[!UICONTROL Map to harmonized fields]**:
   ...
   1. 선택한 필드가 차원 유형인 경우:
      ...
      1. 다음을 선택할 때 **[!UICONTROL Case]**, 선택 **[!UICONTROL Field]** 및 **[!UICONTROL *AEP 데이터 세트 필드&#x200B;*]**또는&#x200B;**[!UICONTROL Value]**및 기본값이 설정되어 있는 필드를 데이터 세트 필드 또는 입력된 값에 매핑합니다.
         ...
         1. 다른 서비스 케이스를 추가하려면 다음을 선택합니다. ![추가](/help/assets//icons/AddCircle.svg) **[!UICONTROL Add case]**&#x200B;를 클릭하여 다른 조건을 추가합니다. ![추가](/help/assets//icons/AddCircle.svg) **[!UICONTROL Add condition]**.

         1. 대/소문자 또는 조건을 삭제하려면 ![닫기](/help/assets//icons/Close.svg) 를 입력합니다.
      ...
      * 를 사용합니다. **[!UICONTROL Case]** **[!UICONTROL Mapping type]** 의 값을 조건부로 매핑하려면 **[!UICONTROL marketing.campaignName]** 의 필드 **[!DNL Luma Transactions]** 데이터 세트를 **[!UICONTROL Campaign]** 조화로운 필드. Campaign harmonized 필드가 다음으로 설정됨:
        ...
        ![데이터 세트 규칙 이벤트](/help/assets//dataset-create-event.png)

1. 선택 ![추가](/help/assets//icons/AddCircle.svg) **[!UICONTROL Add field]** 추가 필드를 정의합니다.
...
데이터 세트 규칙을 편집하려면 ![데이터 검색](/help/assets//icons/DataCheck.svg) **[!UICONTROL Harmonized data]** > **[!UICONTROL Dataset rules]** Mix Modeler 인터페이스:

1. 선택 ![자세히](/help/assets//icons/More.svg) 다음에서 **[!UICONTROL Dataset]** 편집할 데이터 세트 규칙에 대한 열입니다.
1. 컨텍스트 메뉴에서 을(를) 선택합니다 ![편집](/help/assets//icons/Edit.svg) **[!UICONTROL Edit]** 데이터 세트 규칙 편집을 시작합니다. 을(를) 참조하십시오 [데이터 세트 규칙 만들기](#create-a-dataset-rule) 을 참조하십시오.


### 데이터 세트 규칙 삭제

데이터 세트 규칙을 삭제하려면 ![데이터 검색](/help/assets//icons/DataCheck.svg) **[!UICONTROL Harmonized data]** > **[!UICONTROL Dataset rules]** Mix Modeler 인터페이스:

1. 선택 ![자세히](/help/assets//icons/More.svg) 다음에서 **[!UICONTROL Dataset]** 삭제할 데이터 세트 규칙에 대한 열입니다.
1. 컨텍스트 메뉴에서 을(를) 선택합니다 ![삭제](/help/assets//icons/Delete.svg) **[!UICONTROL Delete]** 데이터 세트 규칙을 삭제합니다. 확인을 묻는 메시지가 표시됩니다. 선택 **[!UICONTROL Delete]** 선택한 데이터 세트 규칙을 영구적으로 삭제합니다.
...
1. 선택 ![데이터 병합 환경 설정](/help/assets//icons/Merge.svg) [!BADGE 베타].
...
1. 다음에서 **[!UICONTROL Data merge preferences]** [!BADGE 베타]{type=Informative}
   ...
   * 특정 지표 기반 환경 설정을 추가하려면 다음 작업을 수행하십시오.
      ...
      1. 선택 ![플러스](/help/assets//icons/AddCircle.svg) **[!UICONTROL Add a metric]**.
         ...
         1. 선택 ![플러스](/help/assets//icons/AddCircle.svg) **[!UICONTROL Add a channel]** 또는 ![플러스](/help/assets//icons/AddCircle.svg) **[!UICONTROL Add a conversion type]**.
         1. **[!UICONTROL Summary]** 또는&#x200B;**[!UICONTROL Event]**&#x200B;를 선택합니다.

         채널 또는 전환 유형을 삭제하려면 ![교차](/help/assets//icons/Close.svg).

      1. 더 구체적인 지표 기반 환경 설정을 추가하려면 이전 단계를 반복합니다.

   * 기존 특정 지표 기반 환경 설정을 삭제하려면 다음을 선택합니다. ![삭제](/help/assets//icons/Delete.svg).
