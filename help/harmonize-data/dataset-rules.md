---
title: 데이터 세트 규칙
description: Adobe 믹스 모델러에서 데이터를 조화시키는 과정의 일부로 사용할 데이터 세트 규칙을 정의하는 방법에 대해 알아봅니다.
...
데이터 세트 규칙은 Adobe 믹스 모델러에서 수집한 데이터의 필드와 조화로운 필드를 매핑하는 데 도움이 됩니다.
...
Adobe 믹스 모델러 인터페이스에서 사용 가능한 데이터 세트 매핑의 테이블을 보려면 다음과 같이 하십시오.
...
| 스키마 | 데이터 세트가 준수하는 스키마. 스키마 믹스 모델러 - 스키마의 스키마 편집기에 있는 새 탭에서 Adobe을 열 스키마 이름을 빠르게 선택할 수 있습니다. |
...
데이터 세트 매핑을 생성하려면 ![데이터 검색](../assets/icons/DataCheck.svg) **[!UICONTROL Harmonized data]** > **[!UICONTROL Dataset rules]** Adobe 믹스 모델러에서 인터페이스, 선택 **[!UICONTROL Create Dataset Mapping]**.
...
데이터 세트 매핑을 편집하려면 ![데이터 검색](../assets/icons/DataCheck.svg) **[!UICONTROL Harmonized data]** > **[!UICONTROL Dataset rules]** Adobe 믹스 모델러의 인터페이스:
...
데이터 세트 매핑을 삭제하려면 ![데이터 검색](../assets/icons/DataCheck.svg) **[!UICONTROL Harmonized data]** > **[!UICONTROL Dataset rules]** Adobe 믹스 모델러의 인터페이스:
