...
| 열 이름 | 세부 사항 |
| ---------------------- | ----------|
| **[!UICONTROL Dataset]** | 데이터 세트의 이름입니다.  데이터 집합에 대한 작업을 선택하려면 ![자세히](/help/assets/icons/More.svg)를 사용하세요. 다음과 같은 작업을 수행할 수 있습니다.<ul><li>데이터 집합 규칙 구성을 보려면 ![미리 보기](/help/assets/icons/Preview.svg) **[!UICONTROL View]**&#x200B;하세요. 모든 필드가 비활성화됩니다.</li><li>데이터 집합 규칙 구성을 편집하려면 ![편집](/help/assets/icons/Edit.svg) **[!UICONTROL Edit]**&#x200B;하세요.</li><li>데이터 집합 규칙 구성을 삭제하려면 ![삭제](/help/assets/icons/Delete.svg) **[!UICONTROL Delete]**&#x200B;하십시오. 데이터 세트 삭제 대화 상자에서 삭제를 확인하라는 메시지가 표시됩니다. 데이터 집합 규칙 구성을 영구적으로 삭제하려면 **[!UICONTROL Delete]**&#x200B;을(를) 선택하십시오.</li><ul> |
| **[!UICONTROL Source]** | 데이터 세트의 소스: Adobe Analytics, 경험 이벤트, 요약(집계) 또는 소비자 경험 이벤트. |
| **[!UICONTROL Schema]** | 데이터 세트가 준수하는 스키마. 스키마 이름을 빠르게 선택하여 ![스키마](/help/assets/icons/Schemas.svg) [스키마](../ingest-data/schemas.md)의 스키마 편집기의 새 탭에서 스키마를 열 수 있습니다. |
| **[!UICONTROL Granularity]** | 데이터 집합에 있는 데이터의 세부기간입니다. 가능한 값은 일별, 주별, 월별 또는 연도별입니다. |
| **[!UICONTROL Start of the week]** | 특정 데이터 세트에 대해 새 주의 시작으로 간주되는 요일을 지정합니다. |
| **[!UICONTROL Status]** | 필드의 상태: ![StatusGray](/help/assets/icons/StatusGray.svg) 초안 또는 ![StatusGreen](/help/assets/icons/StatusGreen.svg) 활성 |
| **[!UICONTROL Last modified]** | 데이터 집합 규칙을 마지막으로 수정한 데이터 및 시간입니다. |

{style="table-layout:auto"}

### 데이터 세트 규칙 만들기

데이터 집합 규칙을 만들려면 Mix Modeler의 ![DataSearch](/help/assets/icons/DataCheck.svg) **[!UICONTROL Harmonized data]** > **[!UICONTROL Dataset rules]** 인터페이스에서 **[!UICONTROL Dataset rules configuration]** 마법사의 **[!UICONTROL Create a dataset rule]**&#x200B;을(를) 선택하십시오.

**[!UICONTROL Create]** 화면에서

1. **[!UICONTROL Dataset details]**&#x200B;에서 구성을 시작하려면 **[!UICONTROL Select dataset]**&#x200B;에서 데이터 집합을 선택하십시오. 목록에서 데이터 세트는 **[!UICONTROL Summary]**, **[!UICONTROL Adobe Analytics]**, **[!UICONTROL Experience Event]**, **[!UICONTROL Factors]** 및 **[!UICONTROL Consumer Experience Events]**(으)로 분류됩니다.
...
1. **[!UICONTROL Summary]** 또는 **[!UICONTROL Factors]** 범주의 데이터 집합을 선택한 경우 **[!UICONTROL Data restatement is by]**&#x200B;에 대해 **[!UICONTROL Aggregation]** 또는 **[!UICONTROL Replacement]**&#x200B;을(를) 선택하십시오.
...
1. **[!UICONTROL Map to harmonized fields]** 섹션에서 **[!UICONTROL Standard harmonized field]**&#x200B;에서 조화롭게 구성된 필드를 선택합니다. [새로운 통합 필드를 만들려면](/help/harmonize-data/fields.md#add-a-harmonized-field) **[!UICONTROL Create new]**&#x200B;을(를) 선택하십시오.
...
조정된 필드를 요소 데이터 세트의 필드에 매핑하므로 [모델 구성의 일부로 요소를 추가](/help/models/build.md)할 수 있습니다.

조정된 필드를 요소 데이터 세트의 필드에 매핑하면 다음 항목이 적용됩니다.

##### 요소 이름

요소 데이터 세트의 표준 조화 요소 필드를 매핑할 때 요소 데이터 세트에 단일 요소가 포함되어 있으면 **[!UICONTROL Map into]**&#x200B;을(를) **[!UICONTROL Mapping type]**(으)로 사용하고 **[!UICONTROL Factor Name]** 조화 필드의 기본값을 입력하십시오.

![데이터 집합 규칙 - 단일 요소 데이터 집합 매핑](../assets/dataset-create-rule-factor-single.png)

요소 데이터 집합에 여러 요소가 포함되어 있는 경우 **[!UICONTROL Case As]**&#x200B;을(를) **[!UICONTROL Mapping Type]**(으)로 사용하여 요소 이름 조화 필드와 각 개별 요소 이름 간의 매핑을 정의합니다.

![데이터 집합 규칙 - 단일 요소 데이터 집합 매핑](../assets/dataset-create-rule-factor-multiple.png)


##### 인자 유형

이 필드는 요소 데이터 세트 및 스키마에서 선택 사항입니다. **[!UICONTROL Factor type]**&#x200B;이(가) 요소 데이터 집합 및 스키마에 정의되어 있고 **[!UICONTROL Internal]** 또는 **[!UICONTROL External]**&#x200B;을(를) 지정하는 경우 제공된 값이 사용됩니다. 값을 지정하지 않으면 기본값 **[!UICONTROL Internal]**&#x200B;이(가) 사용됩니다.

##### 값 유형

이 필드는 요소 데이터 세트 및 스키마에서 선택 사항입니다. **[!UICONTROL Value type]**&#x200B;이(가) 요소 데이터 집합 및 스키마에 정의되어 있고 **[!UICONTROL Actual]** 또는 **[!UICONTROL Forecasted]**&#x200B;을(를) 지정하는 경우 제공된 값이 사용됩니다. 값을 지정하지 않으면 기본값 **[!UICONTROL Actual]**&#x200B;이(가) 사용됩니다.


##### 세부기간

요소 데이터 세트 내의 모든 요소가 동일한 소스 세부기간을 갖는 경우 요소 데이터 세트의 세부기간에 대한 데이터 세트 규칙을 정의할 수 있습니다.

요소 데이터 세트가 통합되는 즉시 모든 데이터 세트는 통합된 데이터 세트 전체에서 가장 높은 수준의 세부기간을 준수합니다.


##### 계수 값

**[!UICONTROL Factor value]** harmonized 필드의 경우 집계 연산자 중 하나를 **[!UICONTROL Mapping Type]**(으)로 사용합니다. 요소 데이터 세트에 여러 요소가 정의된 경우 집계 연산자가 모든 요소에 적용됩니다.


##### 예

* 다음 샘플 데이터가 있는 요소 데이터 세트가 있습니다.

  | 타임스탬프 | 요소 이름 | 요소 값 |
  |---|---|---:|
  | 2025년 3월 13일 | _definedsp500 | 10 |
  | 2025년 3월 13일 | _cpi | 20 |
  | 2025년 3월 14일 | _definedsp500 | 30 |
  | 2025년 3월 14일 | _cpi | 40 |
  | 2025년 3월 15일 | _definedsp500 | 50 |
  | 2025년 3월 15일 | _cpi | 60 |


* **[!UICONTROL Factor Name]**, **[!UICONTROL Factor Value]** 및 **[!UICONTROL Granularity]**&#x200B;에 대해 다음 데이터 세트 규칙을 정의합니다.

  ![데이터 집합 규칙 - 요소 예](../assets/dataset-create-rule-factor-example.png)

* 그러면 다음과 같은 데이터가 조화됩니다.

  | 요소 이름 | 요소 값 | 요소 유형 | 값 유형 |
  |---|---:|---|---|
  | CPI | 20 | 내부 | 실제 |
  | S&amp;P 500 | 10 | 내부 | 실제 |

  **[!UICONTROL Factor Type]** 및 **[!UICONTROL Value Type]**&#x200B;에 대해 정의된 데이터 집합 규칙이 없으므로 기본값이 사용됩니다.
...
## 데이터 병합 환경 설정 {#data-merge-preferences}


>[!CONTEXTUALHELP]
>id="harmonizeddata_datasetrules_datamergepreferences"
>title="기본 지표 환경 설정"
>abstract="조화 중에 여러 데이터 소스가 지정된 채널에 대한 지표 필드를 업데이트하려고 할 때 기본 환경 설정이 적용됩니다. 이 환경 설정은 아래에 정의된 경우 특정 지표 환경 설정에 대해 재정의되지 않는 한 샌드박스 수준에서 적용됩니다."
...
1. **[!UICONTROL Save]**&#x200B;을(를) 선택하여 데이터 병합 환경 설정을 저장합니다. 데이터 재동기화가 시작됩니다. <br/>취소할 **[!UICONTROL Cancel]**&#x200B;을(를) 선택하십시오.
